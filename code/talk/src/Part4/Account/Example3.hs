...
handleLimit (LimitInput eMessage bAccount bSoftLimit bHardLimit) = do
  ...
  let
    bSoftLimitReached = softLimitCheck <$> bSoftLimit <*> bAccount
    bHardLimitReached = hardLimitCheck <$> bHardLimit <*> bAccount

    eSoftLimitReached = () <$ filterApply bSoftLimitReached eLines
    eHardLimitReached = () <$ filterApply bHardLimitReached eLines
...
go_3_a_3 :: IO ()
go_3_a_3 = mkGo domainNetworkDescription
